...
class OnBoardingFour extends StatelessWidget{
    ...
    return Scaffold(
        ...
        body: Container(height: height,child: Column(children: [
          ...
          Stack(
            ...
            children: <Widget>[
              Container(child: Image.asset('assets/images/electronics.png',height: height/2.5,width: width,),),
              Stack(
                alignment: Alignment.topCenter,
                children: <Widget>[
  ...
  getTitleText(BuildContext context){
    return Column(mainAxisAlignment: MainAxisAlignment.center,children: [
      Container(width: MediaQuery.of(context).size.width /1.5,margin: EdgeInsets.only(top: middleWare.margin70),child: Text(electricTitle,textAlign: TextAlign.center,style: middleWare.customTextStyle(20, Colors.white, FontWeight.bold)),),
      Container(alignment: Alignment.center,width: MediaQuery.of(context).size.width /1.5,margin: EdgeInsets.only(top: middleWare.margin10),child: Text(electricDescription,textAlign: TextAlign.center,style: middleWare.customTextStyle(16, Colors.white, FontWeight.normal)))
    ]);
  }
