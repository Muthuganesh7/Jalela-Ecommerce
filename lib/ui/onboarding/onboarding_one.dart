...
class OnBoardingOne extends StatelessWidget{
      ...
      return Scaffold(
          ...
          body: Container(height: height,child: Column(children: [
            ...
            Stack(
              ...
              children: <Widget>[
                Container(child: Image.asset('assets/images/grocery_one.png',height: height/2.5,width: width,),),
                // SvgPicture.asset(
                //     'assets/images/grocery_one.svg',
                ...
                Stack(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      ...
                      onTap: (){
                        Navigator.pushNamed(context, RoutePaths.onBoardPage2);
                      },
                    )
                  ],
                )
  ...
  getTitleText(BuildContext context){
    return Column(mainAxisAlignment: MainAxisAlignment.center,children: [
      Container(width: MediaQuery.of(context).size.width /1.5,margin: EdgeInsets.only(top: middleWare.margin70),child: Text(groceryTitle,textAlign: TextAlign.center,style: middleWare.customTextStyle(20, Colors.white, FontWeight.bold))),
      Container(alignment: Alignment.center,width: MediaQuery.of(context).size.width /1.5,margin: EdgeInsets.only(top: middleWare.margin10),child: Text(groceryDescription,textAlign: TextAlign.center,style: middleWare.customTextStyle(16, Colors.white, FontWeight.normal)))
    ]);
  }
  getSlider(){
