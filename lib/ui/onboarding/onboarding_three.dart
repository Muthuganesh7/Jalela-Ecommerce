...
class OnBoardingThree extends StatelessWidget{
    ...
    return Scaffold(
        ...
        body: Container(height: height,child: Column(children: [
          ...
          Stack(
            ...
            children: <Widget>[
              Container(child: Image.asset('assets/images/fashion.png',height: height/2.5,width: width,),),
              Stack(
                alignment: Alignment.topCenter,
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: (){
                      Navigator.pushNamed(context, RoutePaths.onBoardPage4);
                    },
                  )
                ],
              )
  ...
  getTitleText(BuildContext context){
    return Column(mainAxisAlignment: MainAxisAlignment.center,children: [
      Container(width: MediaQuery.of(context).size.width /1.5,margin: EdgeInsets.only(top: middleWare.margin70),child: Text(dressTitle,textAlign: TextAlign.center,style: middleWare.customTextStyle(20, Colors.white, FontWeight.bold))),
      Container(alignment: Alignment.center,width: MediaQuery.of(context).size.width /1.5,margin: EdgeInsets.only(top: middleWare.margin10),child: Text(dressDescription,textAlign: TextAlign.center,style: middleWare.customTextStyle(16, Colors.white, FontWeight.normal)))
    ]);
  }
  getSlider(){
